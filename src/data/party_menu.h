...
enum
{
    ...
    FIELD_MOVE_MOONLIGHT,
    FIELD_MOVE_MORNING_SUN,
};
...
} static const sCursorOptions[] =
{
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_MOONLIGHT] = {gMoveNames[MOVE_MOONLIGHT], CursorCb_FieldMove},
    [MENU_FIELD_MOVES + FIELD_MOVE_MORNING_SUN] = {gMoveNames[MOVE_MORNING_SUN], CursorCb_FieldMove},
};
...
static const u16 sFieldMoves[] =
{
    ...
    MOVE_DIG, MOVE_SECRET_POWER, MOVE_MILK_DRINK, MOVE_SOFT_BOILED, MOVE_SWEET_SCENT, MOVE_MOONLIGHT, MOVE_MORNING_SUN, FIELD_MOVE_TERMINATOR
};
...
} static const sFieldMoveCursorCallbacks[] =
{
    ...
    [FIELD_MOVE_MOONLIGHT]    = {SetUpFieldMove_SunOrMoonlight, PARTY_MSG_CANT_USE_HERE},
    [FIELD_MOVE_MORNING_SUN]  = {SetUpFieldMove_SunOrMoonlight, PARTY_MSG_CANT_USE_HERE},
};
